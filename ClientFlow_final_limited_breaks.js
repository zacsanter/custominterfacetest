    ...
    if (response) {
      response.forEach((item) => {
        if (item.type === "speak" || item.type === "text") {
          ...
          let combinedMessage = formatted_messages.join("<br><br>");
          combinedMessage = combinedMessage.replace(/(<br><br>){3,}/g, "<br><br>");  // Replace instances of more than two consecutive breaks with just two
