    ...
    if (response) {
      response.forEach((item) => {
        if (item.type === "text") {
          ...
          // Extracting individual messages from slate.content
          const paragraphs = item.payload.slate.content.map(contentItem => {
          ...
          messageElement.textContent = combinedMessage;
